...
insert into services (name, id, description, bindable, metadata_id) values ('boundless-suite', '58A0E4B0-DFC2-4CD8-827B-94F6E49EA7BC', 'Open Source Server for Sharing Geospatial Data.', true, 1);
